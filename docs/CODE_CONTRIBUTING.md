...
After that you should run your app to check that everything is correct.
...
We especially appreciate help with issues tagged as "help-wanted", as these are tasks that we are unable to solve due to not having enough experience or knowledge to do so.

New or inexperienced developers can go for issues tagged as "good-first-issue", as these are easier to tackle and are a great way to start getting familiar with the app's code.
...
- Some recurring tasks such as contributing in translations, improving marketplace screenshots, or improving documentation do not usually have a related issue. These tasks are easy to perform, maybe you can start there.
