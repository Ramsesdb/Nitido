...
enum SettingKey {
  ...
  /// Key to storage the app accentColor. It's a string representing the color in HEX format (without the `#`) or the string 'auto' to apply dynamic colors if possible (if not possible will default to the Nitido brand color)
  accentColor,
  ...
  /// Whether biometric lock is enabled on app launch. Opt-in: only '1'
  /// activates the lock; null (fresh install) or '0' both skip
  /// [BiometricLockScreen] entirely. The toggle lives in Settings.
  biometricEnabled,
}
