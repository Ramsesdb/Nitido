...
class NexusCredentialsStore {
  ...
  static const _kModel = 'nexus_ai_model';
  ...
  Future<void> saveModel(String model) async {
    final normalized = _normalizeCredential(model);
    await _storage.write(key: _kModel, value: normalized);
  }

  Future<String> loadModel() async {
    final value = await _storage.read(key: _kModel);
