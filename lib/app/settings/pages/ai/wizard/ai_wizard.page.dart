...
import 'package:nitido/app/settings/pages/ai/wizard/steps/s5_testing.step.dart';
import 'package:nitido/app/settings/pages/ai/wizard/steps/s6_done.step.dart';
...
class _AiWizardPageState extends State<AiWizardPage> {
  ...
  /// and for the final "Empezar a usar nitido" CTA.
  void _exitWizard() {
