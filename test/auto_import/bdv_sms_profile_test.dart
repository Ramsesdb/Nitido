...
import 'package:wallex/core/services/auto_import/profiles/bdv_sms_profile.dart';
...
void main() {
  ...
  RawCaptureEvent _makeEvent(String rawText, {String sender = '2661'}) {
  ...
  group('BdvSmsProfile — Negative tests (should return null)', () {
    ...
    test('Random unrelated message', () {
      final event = _makeEvent('Mensaje random cualquiera');
